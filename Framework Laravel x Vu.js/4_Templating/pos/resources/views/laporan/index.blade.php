...
@push('css')
<link rel="stylesheet" href="{{ asset('/AdminLTE-3/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css') }}">
@endpush
...
@push('scripts')
<script src="{{ asset('/AdminLTE-3/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js') }}"></script>
<script>
    let table;
