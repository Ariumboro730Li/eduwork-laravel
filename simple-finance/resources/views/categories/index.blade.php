                            ...
                            <tbody>
                                @foreach ($categories as $category)
                                    <tr>
                                        ...
                                        @if ($category->is_income == 1)
                                            <td>
                                                <span class="bade badge-success">Income</span>
                                            </td>
                                        @elseif ($category->is_income == 2)
                                            <td>
                                                <span class="bade badge-primary">Income / Outcome</span>
                                            </td>
                                        @else
                                            <td>
                                                <span class="bade badge-danger">Outcome</span>
                                            </td>
                                        @endif
