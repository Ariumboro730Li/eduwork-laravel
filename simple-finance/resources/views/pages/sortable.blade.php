...
@section('content') 
    @component('layouts.headers.auth') 
        @component('layouts.headers.breadcrumbs')
            ...
            <li class="breadcrumb-item"><a href="{{ route('page.index', 'sortable') }}">{{ __('Tables') }}</a></li>
            <li class="breadcrumb-item active" aria-current="page">{{ __('Sortable') }}</li>
        @endcomponent 
    @endcomponent
    ...
    <div class="container-fluid mt--6">
        ...
        <div class="card bg-transparent" data-toggle="list" data-list-values='["name", "budget", "status", "completion"]'>
            <!-- Card header -->
