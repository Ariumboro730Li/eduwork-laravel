								...
								<div class="card-body">
									<div class="row">
										<div class="col-xl-5 col-lg-6 col-md-12 col-sm-12">
											<div class="prime-card"><img class="img-fluid" src="{{asset('assets/img/png/dashboard8.png')}}" alt=""></div>
										</div>
										<div class="col-xl-7 col-lg-6 col-md-12 col-sm-12">
											<div class="text-justified align-items-center">
												<h2 class="text-dark font-weight-semibold mb-3 mt-2">Hi, Welcome Back <span class="text-primary">Nick!</span></h2>
												<p class="text-dark tx-17 mb-2 lh-3"> You have used the 100% of free plan storage. Please upgrade your plan to get unlimited storage.</p>
												<p class="font-weight-semibold tx-12 mb-4">For billing related queries, contact us through support chat or mail us at team@spruko.com </p>
								...
								<div class="card-body p-0 customers mt-1">
									<div class="country-card pt-0">
										<div class="mb-4">
											...
											<div class="progress ht-5 br-5 mt-2">
										...
										<div class="mb-4">
											<div class="d-flex">
												<span class="tx-13 font-weight-semibold">Italy</span>
												<div class="ms-auto"><span class="text-success mx-1"><i class="fe fe-trending-up"></i></span><span class="number-font">$43,537</span> (73%)</div>
											</div>
											<div class="progress ht-5 br-5 mt-2">
										...
										<div class="mb-0">
											...
											<div class="progress ht-5 br-5 mt-2">
												<div class="progress-bar bg-purpple" style="width: 80%"></div>
											</div>
										</div>
									</div>
