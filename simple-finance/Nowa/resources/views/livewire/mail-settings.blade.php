						...
						<div class="col-lg-4 col-xl-3 col-md-12 col-sm-12">
							<div class="card mg-b-20">
								<div class="main-content-left main-content-left-mail card-body">
									<a class="btn btn-primary btn-compose" href="" id="btnCompose">Email Settings</a>
									...
									<form class="form-horizontal">
										...
										<div class="form-group ">
											<div class="row">
												...
												<div class="col-md-9">
													<input type="text" class="form-control"  placeholder="Email" value="info@Nowa.in">
												</div>
											</div>
										</div>
										<div class="form-group ">
										...
										<div class="form-group ">
											<div class="row">
												...
												<div class="col-md-9">
													<a class="" href="javascript:void(0);">Settup Verification</a>
												</div>
											</div>
										</div>
										<div class="form-group ">
										...
										<div class="form-group ">
											<div class="row">
												...
												<div class="col-md-9">
													<a class="mg-r-20" href="javascript:void(0);">Deactivate Account</a>
													<a class="" href="javascript:void(0);">Change Password</a>
												</div>
											</div>
										</div>
									</form>
