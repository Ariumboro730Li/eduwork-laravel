									...
									<div class="card-body">
										<div class="row row-sm">
											<div class="col-lg-12 col-sm-12 mb-2">
												<h6 class="main-content-label">Typicons icons</h6>
												<p class="mb-2">Simply beautiful open source icons. For more info <a href="https://www.s-ings.com/typicons/" target="_blank" class="text-primary">click here</a>.</p>
