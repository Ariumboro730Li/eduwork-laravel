                    ...
                    <div class="container">
						<div class="row about-main mb-5">
							<div class="col-lg-8 col-md-8 col-sm-12 text-center">
								<h1 class="mb-3 font-weight-semibold tx-46">Hello! This is <span class="text-primary tx-56">Nowa.</span></h1>
						...
						<div class="row mb-5 br-5">
							<p><img src="{{asset('assets/img/photos/aboutmain.jpg')}}" class="br-5"  alt="image"></p>
						</div>
						<div class="row mb-5 p-5 about-motto pt-0">
							<div class="col-lg-8 col-md-8 col-sm-12">
								<div class="text-justify">
									<div class="text-dark tx-26 font-weight-semibold">Our Motto</div>
									...
									<div>
										<div class="d-flex mb-4">
											<div>
												<svg class="motto-icon" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" viewBox="0 0 24 24"><path fill="#38cab3" d="M20,4H4.30273c-0.55228,0-1-0.44772-1-1s0.44772-1,1-1H20c0.55228,0,1,0.44772,1,1S20.55228,4,20,4z M15,19v3H9v-3c0-1.65685,1.34315-3,3-3l0,0C13.65685,16,15,17.34315,15,19z M4,12L4,12c-1.10457,0-2-0.89543-2-2V7c0-0.55228,0.44772-1,1-1h3v4C6,11.10457,5.10457,12,4,12z"/><path fill="#87dfd1" d="M8,12L8,12c-1.10457,0-2-0.89543-2-2V6h4v4C10,11.10457,9.10457,12,8,12z"/><path fill="#38cab3" d="M12,12L12,12c-1.10457,0-2-0.89543-2-2V6h4v4C14,11.10457,13.10457,12,12,12z"/><path fill="#87dfd1" d="M16,12L16,12c-1.10457,0-2-0.89543-2-2V6h4v4C18,11.10457,17.10457,12,16,12z"/><path fill="#38cab3" d="M20,12L20,12c-1.10457,0-2-0.89543-2-2V6h3c0.55228,0,1,0.44772,1,1v3C22,11.10457,21.10457,12,20,12z"/><path fill="#afe9e0" d="M18,10c0,1.10455-0.89545,2-2,2s-2-0.89545-2-2c0,1.10455-0.89545,2-2,2s-2-0.89545-2-2c0,1.10455-0.89545,2-2,2s-2-0.89545-2-2c0,1.10455-0.89545,2-2,2v9c0,0.55231,0.44769,1,1,1h4v-3c0-1.65686,1.34314-3,3-3s3,1.34314,3,3v3h4c0.55231,0,1-0.44769,1-1v-9C18.89545,12,18,11.10455,18,10z"/></svg>
											</div>
											<div class="ms-4">
										...
										<div class="d-flex">
											<div>
												<svg class="motto-icon" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 24 24"><path fill="#87dfd1" d="M12,18a3.5,3.5,0,1,1,3.5-3.5A3.50424,3.50424,0,0,1,12,18Z"/><path fill="#38cab3" d="M14.64026,16.77179a3.452,3.452,0,0,1-5.28052,0A4.98821,4.98821,0,0,0,7,21a.99974.99974,0,0,0,1,1h8a.99974.99974,0,0,0,1-1A4.98821,4.98821,0,0,0,14.64026,16.77179Z"/><path fill="#87dfd1" d="M21,12a.99554.99554,0,0,1-.66406-.25244L12,4.33789,3.66406,11.74756a.99991.99991,0,0,1-1.32812-1.49512l9-8a.99893.99893,0,0,1,1.32812,0l9,8A1,1,0,0,1,21,12Z"/><path fill="#afe9e0" d="M12,4.33789,4,11.449V21a.99974.99974,0,0,0,1,1H8a.99974.99974,0,0,1-1-1,4.98821,4.98821,0,0,1,2.35974-4.22821l.00006.00006A3.46882,3.46882,0,0,1,8.5,14.5a3.5,3.5,0,0,1,7,0,3.46882,3.46882,0,0,1-.8598,2.27185l.00006-.00006A4.98821,4.98821,0,0,1,17,21a.99974.99974,0,0,1-1,1h3a.99974.99974,0,0,0,1-1V11.449Z"/></svg>
											</div>
											<div class="ms-4">
                                ...
                                <div class="card bg-secondary-transparent">
                                    <div class="card-body">
                                        <div class="counter-status md-mb-0">
                                            ...
                                            <div class="text-center mb-1">
                                                <h2 class="counter mb-2">7,234</h2>
                                ...
                                <div class="card bg-warning-transparent">
                                    <div class="card-body">
                                        <div class="counter-status md-mb-0">
                                            ...
                                            <div class="text-center mb-1">
                                                <h2 class="counter mb-2">846</h2>
                                                <h6 class="mb-0 text-muted">Available Employeed</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row mb-5">
                                ...
                                <div class="card p-3">
                                    <div class="card-body">
                                        <div class="mb-3 text-center about-team">
                                            <img class="rounded-pill" src="{{asset('assets/img/faces/1.jpg')}}" alt="image">
                                        </div>
										...
										<p class="text-center mb-0"><i class="fe fe-facebook text-primary me-3"></i><i class="fe fe-instagram text-secondary me-3"></i><i class="fe fe-globe text-info me-3"></i></p>
									 </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="card p-3">
                                    <div class="card-body">
                                        <div class="mb-3 text-center about-team">
                                            <img class="rounded-pill" src="{{asset('assets/img/faces/2.jpg')}}" alt="image">
                                        </div>
                                        <div class="tx-16 text-center font-weight-semibold">
                                            Mclaren mcannen
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="card p-3">
                                    <div class="card-body">
                                        <div class="mb-3 text-center about-team">
                                            <img class="rounded-pill" src="{{asset('assets/img/faces/3.jpg')}}" alt="image">
                                        </div>
                                        <div class="tx-16 text-center font-weight-semibold">
                                            Shimpa Craig
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="card p-3">
                                    <div class="card-body">
                                        <div class="mb-3 text-center about-team">
                                            <img class="rounded-pill" src="{{asset('assets/img/faces/4.jpg')}}" alt="image">
                                        </div>
                                        <div class="tx-16 text-center font-weight-semibold">
                                            Limo Peter
                                        </div>
