...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 28 Mar 2022 pada 19.37
...
CREATE TABLE `obat_keluar` (
  ...
  `kode_transaksi` varchar(32) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `obat_keluar` (`id`, `jumlah_keluar`, `kode_transaksi`) VALUES
(1, 12, '');
...
INSERT INTO `obat_masuk` (`id`, `kode_transaksi`, `tanggal_masuk`, `kode_obat`, `jumlah_masuk`, `id_obat`) VALUES
(1, 'h9567834', '2022-03-07', 12345, 100, 0),
(2, 'a12298', '2021-04-05', 1223097, 100, 0),
(3, 'b32156', '2022-03-07', 98765, 150, 0),
(4, 'm567801', '2021-04-05', 540392346, 25, 0),
(5, 'b457809', '2022-03-01', 457302358, 45, 0),
(6, 'w45627', '2022-03-08', 789576, 45, 0),
(7, 'c45738', '2022-03-09', 546847, 52, 0),
(8, 'b346373', '2022-03-03', 4353627, 25, 0),
(9, 'd68583', '2022-03-16', 23546272, 34, 0),
(10, 'd45256', '2022-03-08', 235754, 78, 0);
