@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'classPage' => 'lock-page', 'activePage' => 'lock', 'title' => __('Material Dashboard'), 'pageBackground' => asset("material").'/img/lock.jpg'])
