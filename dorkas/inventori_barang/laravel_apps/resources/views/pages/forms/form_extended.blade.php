            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5 col-md-6 col-sm-3">
                    <select class="selectpicker" id="input-id" data-style="select-with-transition" multiple title="Choose City" data-size="7">
                  ...
                  <span id="category_id-error" class="error text-danger" for="input-id" style="display: block;">The category field is required.</span>
                </div>
              </div>
            </div>
            <div class="row">
