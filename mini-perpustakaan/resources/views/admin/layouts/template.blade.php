...
<head>
    ...
    <title>Selectize select - Robust - Responsive Bootstrap 4 Admin Dashboard Template for Web Application</title>
    ...
    <link
        ...
        rel="stylesheet">
    <!-- BEGIN VENDOR CSS-->
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/app-assets/css/vendors.min.css') }}">
...
<body class="vertical-layout vertical-menu 2-columns   menu-expanded fixed-navbar" data-open="click"
                ...
                <div class="collapse navbar-collapse" id="navbar-mobile">
                            ...
                            <ul class="mega-dropdown-menu dropdown-menu row">
                                <li class="col-md-2">
                                    <h6 class="dropdown-menu-header text-uppercase mb-1"><i
                                            class="fa fa-newspaper-o"></i> News</h6>
                                ...
                                <li class="col-md-3">
                                    <h6 class="dropdown-menu-header text-uppercase"><i class="fa fa-random"></i> Drill
                                        down menu</h6>
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="#"><i class="ft-align-left"></i> Multi level
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="#"><i class="fa fa-star-o"></i> Second
                                                                level menu</a>
                                                            <ul>
                                                                <li><a class="dropdown-item" href="#"><i
                                                                            class="fa fa-heart"></i> Third level</a>
                                                                </li>
                                                                <li><a class="dropdown-item" href="#"><i
                                                                            class="fa fa-heart"></i> Third level</a>
                                                                </li>
                                                        ...
                                                        <li><a class="dropdown-item" href="#"><i
                                                                    class="fa fa-film"></i> Second level, third
                                                                link</a></li>
                                                        <li><a class="dropdown-item" href="#"><i
                                                                    class="fa fa-envelope-o"></i> Second level, fourth
                                                                link</a></li>
                                                    </ul>
                                                </li>
                                                ...
                                                <li><a class="dropdown-item" href="https://pixinvent.ticksy.com/"><i
                                                            class="fa fa-life-ring"></i> Customer support center</a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                                ...
                                <li class="col-md-3">
                                    <h6 class="dropdown-menu-header text-uppercase"><i class="fa fa-list"></i>
                                        Accordion</h6>
                                ...
                                <li class="col-md-4">
                                    <h6 class="dropdown-menu-header text-uppercase mb-1"><i
                                            class="fa fa-envelope"></i> Contact Us</h6>
                    ...
                    <ul class="nav navbar-nav float-right">
                        <li class="dropdown dropdown-language nav-item"><a class="dropdown-toggle nav-link"
                                ...
                                aria-expanded="false"><i class="flag-icon flag-icon-gb"></i><span>English</span><span
                                    class="selected-language"></span></a>
                            <div class="dropdown-menu" aria-labelledby="dropdown-flag"><a class="dropdown-item"
                                    href="#"><i class="flag-icon flag-icon-gb"></i> English</a><a
                        ...
                        <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label"
                                href="#" data-toggle="dropdown"><i class="ficon ft-mail"></i><span
    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion    menu-shadow " data-scroll-to-active="true">
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class=" nav-item"><a href="index.html"><i class="icon-home"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-screen-tablet"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-list"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-share"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-direction"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-social-facebook"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-pencil"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-bulb"></i><span class="menu-title"
                    ...
                    <ul class="menu-content">
                        ...
                        <li><a class="menu-item" href="#" data-i18n="nav.starter_kit.3_columns.main">Content
                                Sidebar</a>
                            <ul class="menu-content">
                                <li><a class="menu-item"
                                        href="../../../starter-kit/ltr/vertical-menu-template/layout-content-left-sidebar.html"
                                        data-i18n="nav.starter_kit.3_columns.3_columns_left_sidebar">Left sidebar</a>
                                </li>
                                <li><a class="menu-item"
                                        href="../../../starter-kit/ltr/vertical-menu-template/layout-content-left-sticky-sidebar.html"
                                        data-i18n="nav.starter_kit.3_columns.3_columns_left_sticky_sidebar">Left sticky
                                        sidebar</a>
                                </li>
                                <li><a class="menu-item"
                                        href="../../../starter-kit/ltr/vertical-menu-template/layout-content-right-sidebar.html"
                                        data-i18n="nav.starter_kit.3_columns.3_columns_right_sidebar">Right sidebar</a>
                                </li>
                                <li><a class="menu-item"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-options-vertical"></i><span
                ...
                <li class=" nav-item"><a href="scrumboard.html"><i class="icon-check"></i><span class="menu-title"
                            data-i18n="nav.scrumboard.main">Scrumboard</span></a>
                </li>
                <li class=" nav-item"><a href="#"><i class="icon-doc"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-film"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-picture"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-magnifier"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-lock-open"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-question"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-paper-clip"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-folder"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-heart"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-speedometer"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-drawer"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-diamond"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-target"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-screen-desktop"></i><span
                    ...
                    <ul class="menu-content">
                        ...
                        <li><a class="menu-item" href="#"
                            ...
                            <ul class="menu-content">
                                ...
                                <li class="active"><a class="menu-item" href="form-selectize.html"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-screen-tablet"></i><span
                ...
                <li class=" nav-item"><a href="#"><i class="icon-speech"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-share-alt"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-note"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-mouse"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-chemistry"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-cloud-upload"></i><span
                ...
                <li class=" nav-item"><a href="#"><i class="icon-calendar"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-info"></i><span class="menu-title"
                ...
                <li class=" navigation-header"><span data-i18n="nav.category.charts_maps">Charts &amp; Maps</span><i
                        class="ft-more-horizontal ft-minus" data-toggle="tooltip" data-placement="right"
                        data-original-title="Charts &amp; Maps"></i>
                </li>
                <li class=" nav-item"><a href="#"><i class="icon-social-google"></i><span
                ...
                <li class=" nav-item"><a href="#"><i class="icon-pie-chart"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-chart"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-disc"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-control-pause"></i><span
                ...
                <li class=" nav-item"><a href="#"><i class="icon-vector"></i><span class="menu-title"
                ...
                <li class=" nav-item"><a href="#"><i class="icon-location-pin"></i><span
                ...
                <li class=" nav-item"><a
                        href="https://pixinvent.com/robust-bootstrap-admin-template/documentation"><i
                    ...
                    <div class="btn-group float-md-right">
                        <button class="btn btn-info dropdown-toggle" type="button" data-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false"><i
                                class="icon-settings mr-1"></i>Action</button>
                        <div class="dropdown-menu arrow"><a class="dropdown-item" href="#"><i
                                    class="fa fa-calendar mr-1"></i> Calender</a><a class="dropdown-item"
                                href="#"><i class="fa fa-cart-plus mr-1"></i> Cart</a><a
                                class="dropdown-item" href="#"><i class="fa fa-life-ring mr-1"></i>
                                Support</a>
                                ...
                                <div class="card-body">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <p>Add <code>.input-selectize</code> class to input field and add value
                                                comma saperated. </p>
                                            <input type="text" class="input-selectize" value="pretty,awesome">
                                        </div>
                                        <div class="form-group">
                                            <h5>Basic Selectize select with Placeholder</h5>
                                            <p>Add <code>.selectize-select</code> class to select for basic Selectize
                                                select field</p>
                                ...
                                <div class="card-body">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <p>Add <code>.selectize-multiple</code> class multiple selectize field</p>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="selectize-multiple" multiple>
                                                ...
                                                <optgroup label="Denmark">
                                                    <option value="13" data-timezone="+01:00">Copenhagen
                                                    </option>
                                                </optgroup>
                                                <optgroup label="England">
                                                    <option value="6" data-timezone="+00:00">Birmingham
                                                    </option>
                                                    ...
                                                    <option value="34" data-timezone="+00:00">Manchester
                                                    </option>
                                                ...
                                                <optgroup label="Germany">
                                                    ...
                                                    <option value="17" data-timezone="+01:00">Düsseldorf
                                                    </option>
                                                ...
                                                <optgroup label="Sweden">
                                                    <option value="22" data-timezone="+01:00">Gothenburg
                                                    </option>
                                ...
                                <div class="card-body">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <p>Add <code>.confirm-selectize</code> class to confirm on remove a value.
                                            </p>
                                            <input type="text" class="confirm-selectize"
                                                value="you,are,pretty,awesome">
                                        </div>
                                        <div class="form-group">
                                            <h5>Contact selector like Email apps</h5>
                                            <p>Add <code>.select-contact</code> class to create contact selector like
                                                Email apps. </p>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <p>Add <code>.repositories</code> class to Integrate github repository </p>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <p>Add <code>.selectize-junk</code> class to lock single select </p>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <p>Add <code>.remove-tags</code> class to get select with remove button
                                                &amp; disabled field</p>
                                            <input type="text" disabled class="remove-tags"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <div id="wrapper">
                                                ...
                                                <p>Add <code>.selectize-event</code> class to find which event fire.
                                                </p>
                                                <div id="log"></div>
                                                <select id="selectize-state" multiple name="state[]"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <p>Add <code>.selectise-drap-drop</code> class to sort options by drag and
                                                drop. </p>
                                            <input type="text" class="selectise-drap-drop"
                                                value="drag,these,items,around">
                                        </div>
                                        <div class="form-group" dir="rtl">
                                            <h5>RTL Input Selectize</h5>
                                            <p>Add <code>.selectize-rtl-input</code> class supports RTL to input. </p>
                                            <input type="text" class="selectize-rtl-input"
                                                value="drag,these,items,around">
                                        </div>
                                        <div class="form-group" dir="rtl">
    ...
    <div class="customizer border-left-blue-grey border-left-lighten-4 d-none d-xl-block"><a
            class="customizer-close" href="#"><i class="ft-x font-medium-3"></i></a><a
            class="customizer-toggle bg-danger box-shadow-3" href="#"><i
        ...
        <div class="customizer-content p-2">
            ...
            <div class="form-group">
                ...
                <div class="btn-group customizer-sidebar-options" role="group" aria-label="Basic example">
                    <button type="button" class="btn btn-outline-info" data-sidebar="menu-light">Light
                        Menu</button>
                    <button type="button" class="btn btn-outline-info" data-sidebar="menu-dark">Dark
                        Menu</button>
                </div>
            </div>
            <hr>
            ...
            <ul class="nav nav-tabs nav-underline nav-justified layout-options">
                <li class="nav-item">
                    <a class="nav-link layouts active" id="tabIcon-tab21" data-toggle="tab"
                        aria-controls="base-tabIcon21" href="#tabIcon21" aria-expanded="true">Layouts</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link navigation" id="tabIcon-tab22" data-toggle="tab"
                        aria-controls="base-tabIcon22" href="#tabIcon22" aria-expanded="false">Navigation</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link navbar" id="tabIcon-tab23" data-toggle="tab"
                        aria-controls="base-tabIcon23" href="#tabIcon23" aria-expanded="false">Navbar</a>
                </li>
            </ul>
            <div class="tab-content px-1 pt-1">
                <div role="tabpanel" class="tab-pane active" id="base-tabIcon21" aria-expanded="true"
                    aria-labelledby="tabIcon-tab21">
                    ...
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" class="custom-control-input" name="fixed-layout"
                            id="fixed-layout">
                    ...
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" class="custom-control-input" name="static-layout"
                            id="static-layout">
                ...
                <div class="tab-pane" id="base-tabIcon22" aria-labelledby="tabIcon-tab22">
                    ...
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" class="custom-control-input" name="native-scroll"
                            id="native-scroll">
                    ...
                    <div class="custom-control custom-checkbox mb-1">
                        ...
                        <label class="custom-control-label" for="collapsible-navigation">Collapsible
                            Navigation</label>
                    </div>
                ...
                <div class="tab-pane" id="base-tabIcon23" aria-labelledby="tabIcon-tab23">
                    ...
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" class="custom-control-input" name="brand-center"
                            id="brand-center">
            ...
            <ul class="nav nav-tabs nav-underline nav-justified color-options">
                <li class="nav-item">
                    <a class="nav-link nav-semi-light active" id="color-opt-1" data-toggle="tab"
                        aria-controls="clrOpt1" href="#clrOpt1" aria-expanded="false">Semi Light</a>
                </li>
                <li class="nav-item">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="custom-control custom-radio mb-1">
                                <input type="radio" name="nav-slight-clr"
                                    class="custom-control-input bg-blue-grey" data-bg="bg-blue-grey"
                                    id="default-solid">
                            ...
                            <div class="custom-control custom-radio mb-1">
                                <input type="radio" name="nav-slight-clr"
                                    class="custom-control-input bg-primary" data-bg="bg-primary"
                                    id="primary-solid">
                            ...
                            <div class="custom-control custom-radio mb-1">
                                <input type="radio" name="nav-slight-clr"
                                    class="custom-control-input bg-success" data-bg="bg-success"
                                    id="success-solid">
                        ...
                        <div class="col-6">
                            ...
                            <div class="custom-control custom-radio mb-1">
                                <input type="radio" name="nav-slight-clr"
                                    class="custom-control-input bg-primary" data-bg="bg-gradient-x-primary"
                                    id="bg-gradient-x-primary">
                            ...
                            <div class="custom-control custom-radio mb-1">
                                <input type="radio" name="nav-slight-clr"
                                    class="custom-control-input bg-success" data-bg="bg-gradient-x-success"
                                    id="bg-gradient-x-success">
                ...
                <div class="tab-pane" id="clrOpt3" aria-labelledby="color-opt-3">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="custom-control custom-radio mb-1">
                                <input type="radio" name="nav-dark-clr"
                                    class="custom-control-input bg-blue-grey" data-bg="bg-blue-grey"
                                    id="solid-blue-grey">
                        ...
                        <div class="col-6">
                            ...
                            <div class="custom-control custom-radio mb-1">
                                <input type="radio" name="nav-dark-clr" checked
                                    class="custom-control-input bg-primary" data-bg="bg-gradient-x-primary"
                            ...
                            <div class="custom-control custom-radio mb-1">
                                <input type="radio" name="nav-dark-clr" checked
                                    class="custom-control-input bg-danger" data-bg="bg-gradient-x-danger"
                            ...
                            <div class="custom-control custom-radio mb-1">
                                <input type="radio" name="nav-dark-clr" checked
                                    class="custom-control-input bg-blue" data-bg="bg-gradient-x-blue"
                                    id="bg-gradient-x-blue1">
                                <label class="custom-control-label" for="bg-gradient-x-blue1">Blue</label>
                            </div>

                            <div class="custom-control custom-radio mb-1">
                                <input type="radio" name="nav-dark-clr" checked
                                    class="custom-control-input bg-cyan" data-bg="bg-gradient-x-cyan"
                                    id="bg-gradient-x-cyan1">
                                <label class="custom-control-label" for="bg-gradient-x-cyan1">Cyan</label>
                            </div>

                            <div class="custom-control custom-radio mb-1">
                                <input type="radio" name="nav-dark-clr" checked
                                    class="custom-control-input bg-pink" data-bg="bg-gradient-x-pink"
                                    id="bg-gradient-x-pink1">
    ...
    <div class="buy-now"><a href="https://1.envato.market/robust_admin" target="_blank"
            class="btn bg-gradient-directional-purple white btn-purple btn-glow px-2">Buy Now</a></div>
