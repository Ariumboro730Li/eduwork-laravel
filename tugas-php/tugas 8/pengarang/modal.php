      ...
      <div class="modal-header bg-info">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="id" class="col-form-label">ID Pengarang</label>
            <input type="text" class="form-control" id="id" name="id_pengarang" placeholder="Masukkan ID Penerbit" required>
          </div>
         <div class="form-group">
...
<?php 
    if(isset($_POST['submit'])) {
            ...
            $result = mysqli_query($mysqli, "INSERT INTO `pengarang` (`id_pengarang`, `nama_pengarang`, `email`, `telp`, `alamat`) VALUES ('$id', '$nama', '$email', '$telp', '$alamat');");
      ...
      <div class="modal-header bg-info">
        ...
        <div class="modal-body ">
          <h5 class="text-center"> Apakah Ingin Menghapus Data Ini ?</h5>
            <div class="text-white bg-danger text-center"><?= $hasil_data['id_pengarang'] ?> - <?= $hasil_data['nama_pengarang'] ?></div>
...
<div class="modal fade roman" id="Modaledit<?= $id; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog ">
    <div class="modal-content">
      <div class="modal-header bg-info">
        ...
        <form  action="" method="post">
          <div class="form-group">
            <label for="id" class="col-form-label">ID Pengarang</label>
            <input type="text" class="form-control" id="id" name="ubah_id" placeholder="Masukkan ID Penerbit" value="<?= $hasil_data['id_pengarang'];?>" readonly required>
          </div>
          <div class="form-group">
            <label for="nama" class="col-form-label">Nama Pengarang</label>
            <input type="text" class="form-control" id="nama" name="ubah_nama" placeholder="Masukkan Nama Penerbit" value="<?= $hasil_data['nama_pengarang']?>" required>
          </div>
          <div class="form-group">
            <label for="email" class="col-form-label">Email</label>
    ...
    if(isset($_POST['ubah'])) {
            ...
            $result = mysqli_query($mysqli, "UPDATE pengarang SET nama_pengarang = '$ubah_nama', email = '$ubah_email', telp = '$ubah_telp', alamat = '$ubah_alamat'  WHERE id_pengarang = '$id'");
