...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        //             ->groupBy('transactions.members.id')
        ...
        //no 7
        // $data7 = Transaction::select('members.name', 'members.phone_number', 'members.address', 'transactions.date_start', 'transactions.date.end')
        //                 ->join('members', 'transactions.member_id', '=', 'members.id')
        //                 ->whereMonth('date_end', '6')
        //                 ->get();

        //no 8
        // $data8 = Transaction::select('members.name', 'members.phone_number', 'members.address', 'transactions.date_start', 'transactions.date.end')
        //                 ->join('members', 'transactions.member_id', '=', 'members.id')
