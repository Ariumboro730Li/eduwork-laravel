...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        // // no 13
        $data13 = TransactionDetail::select('members.name', 'members.phone_number', 'members.address', 'transactions.date_start', 'transactions.date_end', 'books.isbn', 'transaction_details.qty', 'books.title', 'books.price', DB::raw('books.price * transaction_details.qty'))
            ->join('transactions', 'transaction_details.transaction_id', '=', 'transactions.id')
            ->join('members', 'transactions.member_id', '=', 'members.id')
            ->join('books', 'transaction_details.book_id', '=', 'books.id')->toSql();
