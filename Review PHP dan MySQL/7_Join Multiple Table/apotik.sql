...
--
-- Table structure for table `detail_box`
--
...
--
-- Dumping data for table `detail_box`
--

INSERT INTO `detail_box` (`id_perbox`, `barcode`, `qty_box`) VALUES
(3, 4, 39),
(7, 6, 23),
(5, 3, 43),
(9, 7, 86),
...
--
-- Constraints for table `detail_box`
--
ALTER TABLE `detail_box`
  ADD CONSTRAINT `detail_box_ibfk_1` FOREIGN KEY (`id_perbox`) REFERENCES `perbox` (`id_box`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `detail_box_ibfk_2` FOREIGN KEY (`barcode`) REFERENCES `obat` (`barcode`) ON DELETE CASCADE ON UPDATE CASCADE;
