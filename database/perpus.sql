...
-- Membuang data untuk tabel perpus.buku: ~17 rows (lebih kurang)
...
-- Membuang data untuk tabel perpus.penerbit: ~7 rows (lebih kurang)
INSERT INTO `penerbit` (`id_penerbit`, `nama_penerbit`, `email`, `telp`, `alamat`) VALUES
	('PN01', 'Penerbit 01', 'penerbit01@perpus.co.id', '02199993331', 'Bondowoso'),
...
-- Membuang data untuk tabel perpus.pengarang: ~7 rows (lebih kurang)
