...
--
-- Host: 127.0.0.1
-- Generation Time: May 10, 2023 at 09:11 AM
...
CREATE TABLE `pabrik_obat` (
  `id_far` varchar(20) NOT NULL,
  `id_obat` varchar(40) NOT NULL,
  `Jenis Obat` varchar(20) NOT NULL,
  `Nama Obat` varchar(40) NOT NULL,
  `Sifat Fisik obat` varchar(20) NOT NULL,
  `Usia Pengguna` varchar(10) NOT NULL,
...
INSERT INTO `pabrik_obat` (`id_far`, `id_obat`, `Jenis Obat`, `Nama Obat`, `Sifat Fisik obat`, `Usia Pengguna`, `tgl_Pembuatan`, `tgl_Exp`) VALUES
('12Par', 'OB_3224', 'Biasa', 'Parasetamol', 'Kapsul', '6-15 thn', '2021-05-04', '2023-05-11'),
('13bur', 'OB_3224', 'Keras', 'Amplodipen', 'pill', '40-60 Thn', '2019-04-01', '2020-04-01');
...
--
-- Constraints for table `pabrik_obat`
--
ALTER TABLE `pabrik_obat`
  ADD CONSTRAINT `pabrik_obat_ibfk_1` FOREIGN KEY (`id_obat`) REFERENCES `obat` (`id_obat`);
