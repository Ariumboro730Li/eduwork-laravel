...
if(isset($_POST['submit']))
{
    ...
    $result = mysqli_query($anggota_connect, "INSERT INTO anggota(id_anggota, nama , username, password, sex, tlp, alamat, email, tgl_entry, role) 
  ...
  if($result)
  {
    ...
    die(mysqli_error($anggota_connect));
  }
