...
<body>
	...
	<form action="edit.php?isbn=<?php echo $isbn; ?>" method="post">
		<table width="25%" border="0">
			...
			<tr> 
				<td>Tahun</td>
				<td><input type="varchar" name="tahun" value="<?php echo $tahun; ?>"></td>
			</tr>
			<tr> 
				<td>Penerbit</td>
				<td>
			...
			<tr> 
				<td>Qty Stok</td>
				<td><input type="int" name="qty_stok" value="<?php echo $qty_stok; ?>"></td>
			</tr>
			<tr> 
				<td>Harga Pinjam</td>
				<td><input type="int" name="harga_pinjam" value="<?php echo $harga_pinjam; ?>"></td>
			</tr>
			<tr> 
				<td></td>
	...
	<?php
		...
		if(isset($_POST['update'])) {
			...
			$result = mysqli_query($mysqli, "UPDATE buku SET judul = '$judul', tahun = '$tahun', id_penerbit = '$id_penerbit', id_pengarang = '$id_pengarang', id_katalog = '$id_katalog', Jmh_Stok = '$qty_stok', harga_pinjam = '$harga_pinjam' WHERE isbn = '$isbn';");
